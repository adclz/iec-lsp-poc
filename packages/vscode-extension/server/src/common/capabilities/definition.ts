import { TypeDefinitionParams, Hover, MarkupKind, LocationLink, Location, DefinitionParams } from "vscode-languageserver";
...
const typeDefinitionProvider = (singleTons: SingleTons):
    (params: DefinitionParams) => Promise<Location | Location[] | LocationLink[] | null> => {
    const {
        documents,
        trees,
        buffers
