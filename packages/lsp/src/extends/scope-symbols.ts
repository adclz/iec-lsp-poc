...
import { Scope, ScopeOrSymbol } from "../symbols/definitions"
import { FunctionScope } from "../symbols/scopes/function"
...
export const scopedCompletionProvider = (scope: ScopeOrSymbol | null) => {
    if (scope) {
