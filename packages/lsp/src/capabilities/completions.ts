...
import { LazySymbol } from "../symbols/symbols/lazy";
...
const checkCursorWithinGroup = (node: Parser.SyntaxNode, params: CompletionParams) => {
...
const treeSitterCompletion = (params: CompletionParams, tree: Parser.Tree): CompletionItem[] => {
...
const completionProvider = (globalState: GlobalState): (params: CompletionParams) => Promise<CompletionList | CompletionItem[]> => {
    const {
        documents,
        trees,
        symbols
